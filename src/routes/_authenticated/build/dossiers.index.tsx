    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Briefs generated by public visitors via `/m/:publicToken`.
        </p>
      </header>

      {dossiers.length === 0 ? (
        <div className="rounded-lg border border-dashed border-border bg-card p-8 text-center">
          <p className="text-sm text-muted-foreground">No dossier generated yet.</p>
          <p className="mt-1 text-xs text-muted-foreground">
            Publish a mission then share the `/m/:publicToken` link to collect briefs.
          </p>
        </div>
      ) : (
