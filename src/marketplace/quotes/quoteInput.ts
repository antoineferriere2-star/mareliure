...
export const billingProfileInput = z
  .object({
    ...
    vatRegime: z.enum(["FRANCHISE", "VAT_LIABLE", "EXEMPT"]).nullable(),
    ...
    paymentDelayDays: z.number().int().min(0).max(365).nullable().default(30),
    earlyPaymentDiscountTerms: optionalText(1000),
    latePenaltyTerms: optionalText(1000),
