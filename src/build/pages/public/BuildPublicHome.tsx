      ...
      <section className="bg-slate-50 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-5 text-[15px] leading-7 text-slate-700">
            Métré Build helps customers clarify their project without forcing your business to build
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-4 text-[16px] leading-7 text-slate-700">
            Métré Build was founded by Antoine Ferrière, a construction entrepreneur with more than
            15 years of experience across timber construction, renovation and project delivery.
          </p>
          <a
