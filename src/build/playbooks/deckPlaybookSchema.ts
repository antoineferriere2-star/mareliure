...
export const deckPlaybookSchema: PlaybookSchema = {
          ...
          fields: [
            {
              ...
              options: ["New deck", "Deck replacement", "Deck extension", "Deck resurfacing", "Not sure"].map(choice),
              briefMapping: { section: "confirmedInformation", label: "Project type", category: "Project details", format: "raw" },
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              type: "single_choice",
              desirability: "required",
              options: ["Single-family home", "Townhouse", "Commercial property", "Other"].map(choice),
              briefMapping: { section: "confirmedInformation", label: "Property type", category: "Project details", format: "raw" },
            },
            {
              ...
              type: "single_choice",
              desirability: "required",
              options: ["No existing deck", "Existing wood deck", "Existing composite deck", "Patio or concrete slab", "Other"].map(choice),
              briefMapping: { section: "confirmedInformation", label: "Existing situation", category: "Project details", format: "raw" },
            },
          ],
        },
        {
          ...
          fields: [
            { key: "length", label: "Length (ft)", type: "measurement", unit: "ft", desirability: "optional" },
            { key: "width", label: "Width (ft)", type: "measurement", unit: "ft", desirability: "optional" },
            {
              key: "totalArea",
          ...
          fields: [
            {
              ...
              desirability: "required",
              minSelected: 1,
              options: ["Ground-level", "Elevated", "Second-story", "Stairs required", "Access limitations"].map(choice),
              briefMapping: { section: "constraints", label: "Height/access", category: "Site", format: "join_comma" },
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              type: "single_choice",
              desirability: "required",
              options: ["Pressure-treated wood", "Cedar or hardwood", "Composite", "PVC", "Not sure"].map(choice),
              briefMapping: { section: "confirmedInformation", label: "Desired material", category: "Project details", format: "raw" },
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              type: "multi_choice",
              desirability: "optional",
              options: ["Stairs", "Railing", "Lighting", "Privacy screen", "Pergola", "Built-in seating", "Other"].map(choice),
              briefMapping: { section: "confirmedInformation", label: "Features", category: "Project details", format: "join_comma" },
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              briefMapping: { section: "confirmedInformation", label: "Photos", category: "Attachments", format: "join_comma" },
            },
          ],
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              type: "timeline",
              desirability: "required",
              options: ["As soon as possible", "Within 3 months", "3-6 months", "6-12 months", "Just exploring"].map(choice),
          ...
          fields: [
            {
              ...
              briefMapping: { section: "confirmedInformation", label: "Location", category: "Prospect", format: "raw" },
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              type: "text",
              desirability: "required",
              briefMapping: { section: "confirmedInformation", label: "Name", category: "Prospect", format: "raw" },
            },
            {
              key: "email",
              label: "Email",
              ...
              desirability: "required",
              pattern: "^\\S+@\\S+\\.\\S+$",
              briefMapping: { section: "confirmedInformation", label: "Email", category: "Prospect", format: "raw" },
            },
            {
              key: "phone",
              label: "Phone",
              ...
              briefMapping: { section: "confirmedInformation", label: "Phone", category: "Prospect", format: "raw" },
            },
            {
              ...
              briefMapping: { section: "confirmedInformation", label: "Preferred contact", category: "Prospect", format: "raw" },
            },
            {
              key: "consent",
  ...
  briefConfig: {
    ...
    summaryFragments: [
      ...
      { template: "for a {{propertyType|lower}}", when: { all: [{ fieldKey: "propertyType", operator: "is_not_empty" }] } },
      {
        template: "around {{computedArea}}",
        when: { any: [{ fieldKey: "length", operator: "is_not_empty" }, { fieldKey: "totalArea", operator: "is_not_empty" }] },
      },
      {
        template: "with dimensions still unclear",
        when: { all: [{ fieldKey: "length", operator: "is_empty" }, { fieldKey: "totalArea", operator: "is_empty" }] },
      },
      {
    ...
    derivedLines: [
      {
        ...
        section: "constraints",
        when: { all: [{ fieldKey: "existingSituation", operator: "is_not_empty" }, { fieldKey: "existingSituation", operator: "not_equals", value: "No existing deck" }] },
      ...
      },
      {
        ...
        section: "constraints",
        when: { all: [{ fieldKey: "heightAccess", operator: "includes", value: "Access limitations" }] },
        label: "Access",
    ...
    alwaysIncludeLines: [
      { section: "missingInformation", label: "Permits", value: "Permit requirements were not assessed in this demo." },
      { section: "missingInformation", label: "Structural condition", value: "Existing structure condition requires human review." },
    ],
