...
- Vérifications locales vertes après les derniers ajustements : typecheck, lint, suite Vitest complète et build Vite. PR #27 ouverte ; la CI distante reste le contrôle final. Ne pas appliquer la migration, fusionner ni déployer sans validation. La recette E2E authentifiée avec création réelle d'un atelier et dépôt de demande attend un environnement de revue portant la migration.
